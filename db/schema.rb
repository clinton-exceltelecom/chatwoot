...
ActiveRecord::Schema[7.1].define(version: 2026_05_25_093000) do
  ...
  create_table "channel_email", force: :cascade do |t|
    ...
    t.boolean "conversation_id_in_subject", default: false, null: false
    t.integer "include_original_in_reply", default: 2, null: false
  ...
  create_table "inboxes", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "allowed_custom_attribute_keys", default: []
